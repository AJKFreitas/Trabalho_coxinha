...
import br.cesjf.lucaslpwd.model.Usuario;
...
public class UsuarioDAO implements Serializable {
    ...
    public String remover(Usuario usuario) {
        try {
            System.err.println("oi" + usuario.getIdUsuario());
            EntityManager em = PersistenceUtil.getEntityManager();
            ...
            return "Não foi possível remover o usuario " + usuario.getNmUsuario()+ ", pois ele possui reservas ou empréstimos vinculados";
        }
    }
    ...
    public String persistir(Usuario usuario) {
        try {
            ...
            if(e.getMessage().contains("ConstraintViolationException")){
                return "Não foi possível salvar o usuário " + usuario.getNmUsuario() + ", pois o usuário deve ser único";
            }
            return "Não foi possível salvar o usuário " + usuario.getNmUsuario() + "!";
        }
    }
