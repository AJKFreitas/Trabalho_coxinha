...
public class UsuarioHasQuestaoPK implements Serializable {
    ...
    public String toString() {
        return "br.cesjf.lucaslpwd.model.UsuarioHasQuestaoPK[ usuarioIdUsuario=" + usuarioIdUsuario + ", questaoIdQuestao=" + questaoIdQuestao + ", questaoProvaIdProva=" + questaoProvaIdProva + " ]";
    }
