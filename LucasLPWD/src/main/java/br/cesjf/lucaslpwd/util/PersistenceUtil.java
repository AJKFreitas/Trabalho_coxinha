 ...
 */
package br.cesjf.lucaslpwd.util;
...
public class PersistenceUtil {
    private static final String PERSITENCE_UNIT_NAME = "ENADE.PU";
        ...
        if(FACTORY == null){
            try {
                ...
                Logger.getLogger(PersistenceUtil.class.getName()).log(
                        Level.WARNING,"Falha na criação do EntityManagerFactory",e.getMessage());
